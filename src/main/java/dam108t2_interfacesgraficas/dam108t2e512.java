...
public class dam108t2e512 extends javax.swing.JFrame {
...
//al final de NuevaPartida():
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dam108t2e512.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dam108t2e512().setVisible(true);
            }
        });
    }
